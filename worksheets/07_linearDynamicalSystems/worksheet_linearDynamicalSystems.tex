...
\begin{enumerate}
    ...
    \item Sample (i.e., simulate) observations from a linear dynamical system
        for tracking.
        Follow the equations on slide 16 of the
        ...
        $\mathbf{x}_2},\ldots,\mathbf{x}_N$, and finally simple the
        observations $\mathbf{y}_1,\ldots,\mathbf{y}_N$.

        You may use the script \href{}{doSimulateTrajectoryDWPA.py} in the class repository, but you will
        need to complete a few missing parts in the module
        \href{}{simulation.py}. 
