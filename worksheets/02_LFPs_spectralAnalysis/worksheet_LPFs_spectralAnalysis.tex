...
\begin{enumerate}
    ...
    \item We measure the LFP in human motor cortex with an Utah array. It is
        ...
        $LFP(t)=A \cos(\omega_0\,t)$ with $\omega_0=2\pi\,f_0$~rad/sec,
        ...
        \begin{figure}
            \begin{center}
                ...
                \cos(\omega_0\,t)$ with $\omega_0=2\pi\,f_0$~rad/sec,
                ...
                \href{https://github.com/joacorapela/neuroinformatics24/blob/master/worksheets/02_LFPs_spectralAnalysis/doExUndersampledLFP.py}{here}.}
        ...
        \begin{enumerate}[(a)]
            ...
            \item build another example of an LFP having an oscillation at a
                ...
                can use
                \href{https://github.com/joacorapela/neuroinformatics24/blob/master/worksheets/02_LFPs_spectralAnalysis/doExUndersampledLFP.py}{this} code to verify that with your values of
                the the LFP frequency and the sampling frequency an oscillation
                at a low frequency emereges.

        \end{enumerate}

    \item solve \href{https://drive.google.com/file/d/1DC4iRo58uZxRlX-KESSlT-861CUXQrz2/view}{Ken's worksheet on power spectra}.
